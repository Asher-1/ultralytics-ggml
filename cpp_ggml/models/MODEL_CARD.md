...
| CUDA    | yes | yes | yes  | cuDNN 9.1 F16 snapshot: all 11 models beat its PyTorch-CUDA baseline |
| Vulkan  | yes | yes | yes  | F16 snapshot: all 11 models meet the declared x0.70 proximity floor  |
