...
Ultralytics checkout. Segmentation models additionally emit 32 mask prototypes at one-quarter resolution and compose
instance masks on device. The depth model produces one floating-point distance in meters per source pixel.
...
| CUDA    | yes | yes | yes  | 10 of 11 detectors and depth beat the PyTorch-CUDA baseline; all 30 segmentation keys under 30 ms graph time |
| Vulkan  | yes | yes | yes  | 8 of 11 detectors and depth beat PyTorch; 28 of 30 segmentation keys under 30 ms |
